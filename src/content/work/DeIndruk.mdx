...
<ExpandableList
  ...
  items={[
    "Worked on responsive and customized websites using a WordPress theme called The-Blueprint made by DeIndruk, which used Sage (a starter theme) as its base.",
  ]}
/>
...
<ExpandableList
  ...
  items={[
    "Performed maintenance and troubleshooting for clients under a Service Level Agreement.",
    "Helped resolve bugs and applied updates to improve website stability and security.",
  ]}
/>
